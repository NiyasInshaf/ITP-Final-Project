...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  ...
  $updateSQL = "UPDATE carts SET status = '".$_POST['description']."' WHERE seno = '".$_POST['order_id']."'";
...
?>
    <tr>
	  ...
	  <?php } while ($row_get_tracking_data = mysql_fetch_assoc($get_tracking_data)); ?>
		...
		<div style="margin-top:10px;"><button class="btn btn-block btn-primary" onclick="window.open('print_tracking.php?id=<?php echo $orderID; ?>','popup','width=600,height=600'); return false;">Print Tracking Note</button></div>
	<br>
